...
func setupAUGraph(player: UnsafeMutablePointer<MyMIDIPLayer>) throws {
    ...
    var presetPlist = CFPropertyListCreateWithData(kCFAllocatorSystemDefault,
    ...
    checkError(AudioUnitSetProperty(player.pointee.instrumentUnit,
                                    kAudioUnitProperty_ClassInfo,
                                    kAudioUnitScope_Global,
                                    0,
                                    &presetPlist,
                                    UInt32(MemoryLayout.size(ofValue: presetPlist))),
